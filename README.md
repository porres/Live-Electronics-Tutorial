...
#### Version: 1.0-0 RC-7 (Release Candidate #7): Released: March 1st 2023

 - This particular version of the tutorial requires **Pd 0.53-1** or later and depends on **ELSE 1.0-0 RC 7** (<https://github.com/porres/pd-else/releases/tag/v1.0-rc7)! 
